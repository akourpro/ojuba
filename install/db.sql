-- phpMyAdmin SQL Dump
-- أُعجوبة (Ojuba) — بنية قاعدة البيانات فقط (بدون أي بيانات تجريبية)
-- يمكن استيرادها مباشرة عبر phpMyAdmin، أو تشغيل معالج التثبيت install.php
-- الذي يستخدم نفس هذا الملف تلقائياً.
--
-- ملاحظة: تم تجريد كل جمل INSERT INTO عمداً من هذا الملف (كانت تحتوي بيانات
-- حقيقية بنسخة التطوير الأصلية) — لا حاجة لأي بيانات مبدئية، حساب المالك
-- الأول يُنشأ عبر install.php.
