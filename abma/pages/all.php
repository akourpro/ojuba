...
?>
<title>الصفحات</title>
<h4 class="py-3 mb-4"><span class="text-muted fw-light">الصفحات /</span> عرض الكل</h4>
<style>
    .swal2-container {
        z-index: 1000000;
    }
...
<div class="row">
    <div class="col-sm">
        <a href="pages/new" class="btn btn-secondary waves-effect waves-light"><i class="mdi mdi-plus"></i> انشاء صفحة جديدة</a>
    </div>
</div>
<div class="card mt-2">
    <div class="table-responsive">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                dbSelect("pages", "id, name, name_en, slug, status", "ORDER BY id DESC");
                foreach ($rows as $row) {
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a href="../page/' . $row['slug'] . '" target="_blank" class="dropdown-item text-primary"><i class="mdi mdi-eye"></i> عرض</a>
                                    <a href="pages/' . $row['id'] . '/edit" class="dropdown-item text-warning edit"><i class="mdi mdi-pen"></i> تعديل</a>
