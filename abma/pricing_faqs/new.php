<title>اضافة سؤال جديد - صفحة الأسعار</title>
<?php
$status = '';
if (isset($_POST['submit'])) {
  ...
  dbInsert("pricing_faqs", $columns, $values);
  sweet("success", "تم", "تمت الإضافة بنجاح", "pricing-faqs");
  exit;
}
?>
<div class="card mb-4">
  <h5 class="card-header">إضافة سؤال جديد لصفحة الأسعار</h5>
