$("#addNewBtn").click(function () {
    resetForm();
    $("#addEventSidebarLabel").text("إضافة تصنيف جديد");
    $("#saveEventBtn").text("إضافة");
});

// تعديل تصنيف - جلب البيانات من API
$(".edit-btn").click(function () {
    ...
    $.ajax({
        ...
        if (data.status) {
            ...
            $("#addEventSidebarLabel").text("تعديل التصنيف");
...
$(".delete").click(function () {
    ...
    Swal.fire({
        title: "هل انت متأكد من حذف التصنيف: " + category_name,
        icon: "error",
